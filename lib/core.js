...
exports.createQueryTester =
  ...
  exports.containsOperation =
  exports.numericalOperation =
  exports.numericalOperationCreator =
  exports.createEqualsOperation =
  exports.EqualsOperation =
  exports.createTester =
  exports.NestedOperation =
  exports.QueryOperation =
  exports.NamedGroupOperation =
...
const walkKeyPathValues = (item, keyPath, next, depth, key, owner) => {
  ...
  // { $eq: [1, 2, 3] }, [ 1, 2, 3 ].
  if ((0, utils_1.isArray)(item) && isNaN(Number(currentKey)) && !(0, utils_1.isProperty)(item, currentKey)) {
...
const numericalOperation = (createTester) =>
  (0, exports.numericalOperationCreator)((params, owneryQuery, options, name) => {
    const typeofParams = typeof (0, utils_1.comparable)(params);
    const test = createTester(params);
    return new EqualsOperation(
      (b) => {
        const actualValue = (0, utils_1.coercePotentiallyNull)(b);
        return typeof (0, utils_1.comparable)(actualValue) === typeofParams && test(actualValue);
      },
      owneryQuery,
      options,
      name
