...
class $Never extends core_1.BaseOperation {
  constructor(params, ownerQuery, options, name) {
    super(params, ownerQuery, options, name);
    this.propop = true;
...
class $Always extends core_1.BaseOperation {
  constructor() {
    super(...arguments);
    this.propop = true;
  }
  init() {
    if ((0, core_1.containsOperation)(this.params, this.options)) {
      throw new Error(`cannot nest $ under ${this.name.toLowerCase()}`);
    }
    this._test = (0, core_1.createTester)(this.params, this.options.compare);
  }
...
class $And extends core_1.NamedGroupOperation {
  constructor(params, owneryQuery, options, name) {
    super(
      ...
      owneryQuery,
      options,
      params.map((query) => (0, core_1.createQueryOperation)(query, owneryQuery, options)),
      name
    );
    this.propop = false;
...
exports.$nin = $nin;
const $never = (params, owneryQuery, options, name) => new $Never(params, owneryQuery, options, name);
exports.$never = $never;
const $always = (params, owneryQuery, options, name) => new $Always(params, owneryQuery, options, name);
exports.$always = $always;
const $in = (params, owneryQuery, options, name) => {
  return new $In(params, owneryQuery, options, name);
};
exports.$in = $in;
exports.$lt = (0, core_1.numericalOperation)((params) => (b) => {
  return b != null && b < params;
});
exports.$lte = (0, core_1.numericalOperation)((params) => (b) => {
  return b === params || b <= params;
});
exports.$gt = (0, core_1.numericalOperation)((params) => (b) => {
  return b != null && b > params;
});
exports.$gte = (0, core_1.numericalOperation)((params) => (b) => {
  return b === params || b >= params;
});
...
const $type = (clazz, owneryQuery, options) =>
